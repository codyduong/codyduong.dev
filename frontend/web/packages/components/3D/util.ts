...
import type { CompoundBodyProps, ConvexPolyhedronArgs, ConvexPolyhedronProps } from '@react-three/cannon';

export function toConvexProps(bufferGeometry: BufferGeometry): ConvexPolyhedronArgs {
...
export function toConvexPolyhedronArgs(bufferGeometry: BufferGeometry): ConvexPolyhedronArgs {
  const geo = new Geometry().fromBufferGeometry(bufferGeometry);
