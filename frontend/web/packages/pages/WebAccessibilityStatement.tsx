    ...
    <Content>
      <Section>
        ...
        <T.P2>
          ...
          ) am commited to ensuring digital accessibility. As such, I&apos;ve
          done the best I could to ensuing compliance to various accessibility
          guidelines and standards to ensure the best user experience for
          everyone.
        </T.P2>
        ...
        <ul>
          <li>
            E-Mail:{' '}
            <A.Styled href="mailto:accessibility@codyduong.dev">
